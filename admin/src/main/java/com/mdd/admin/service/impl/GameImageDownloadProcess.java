...
import com.mdd.admin.service.IGameImageService;
...
@Service
@Scope("prototype")
public class GameImageDownloadProcess implements IGameImageService {
    private String keyuri;
    @Autowired
    XModImagesMapper imagesMapper;
    public GameImageDownloadProcess(String keyuri) {
        this.keyuri = keyuri;
    }
    ...
    public void onDownloadStart(){
        XModImages gameImage = imagesMapper.selectOne(new QueryWrapper<XModImages>().eq("keyuri", keyuri));
        if (gameImage != null){
            gameImage.setStatus("upload");
    ...
    public void onDownloadComplete(String fileURL, String saveFile) {
        ...
        try {
            ...
            if (imagesMapper != null){
                XModImages gameImage = imagesMapper.selectOne(new QueryWrapper<XModImages>().eq("keyuri", keyuri));
                if (gameImage != null){
                    gameImage.setSize(fileSize);
