...
public class CaptchaCache {
    ...
    public static String get(String uuid) {
        ...
        String captchaKey = YmlUtils.get("app.captcha.token") + ip + ":" + uuid;
    ...
    public static void set(String code, String uuid) {
        String ip   = IpUtils.getIpAddress().replaceAll("\\.", "");
        String verifyKey = YmlUtils.get("app.captcha.token") + ip + ":" + uuid;
        long expireTime = Long.parseLong(YmlUtils.get("app.captcha.expire"));
